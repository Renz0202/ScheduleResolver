...
class AiScheduleService extends ChangeNotifier {
  ...
  Future<bool> analyzeSchedule(List<TaskModel> tasks) async {
    ...
    try {
     ...
     and suggest a better balance schedule. Consider their urgency, importance, and required energy level.
     ...
     2. ### Ranked Tasks
     Rank which tasks need attention first based on urgency, importamce, and energy. Provide a brief reason for each
